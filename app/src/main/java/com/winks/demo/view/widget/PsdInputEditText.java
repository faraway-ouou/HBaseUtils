 ...
 * @author zhangqin
 */
public class PsdInputEditText extends AppCompatEditText {
     ...
     * 底部线的颜色   默认GRAY
     */
    private int bottomLineColor = Color.parseColor("#D2D2D2");

    /**
     * 分割线的颜色
     */
    private int borderColor = Color.parseColor("#D2D2D2");
     ...
     * 竖直分割线的颜色
     */
    private int divideLineColor = Color.parseColor("#D2D2D2");
     ...
     * @param attrs
     */
    public PsdInputEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.input_pas_style);
        maxCount = typedArray.getInt(R.styleable.input_pas_style_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.input_pas_style_circleColor, circleColor);
        textSize = typedArray.getDimension(R.styleable.input_pas_style_textSize, textSize);
        bottomLineColor = typedArray.getColor(R.styleable.input_pas_style_bottomLineColor, bottomLineColor);
        pwdRadius = typedArray.getDimension(R.styleable.input_pas_style_pwdRadius, pwdRadius);

        divideLineWidth = typedArray.getDimension(R.styleable.input_pas_style_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.input_pas_style_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.input_pas_style_psdType, psdType);
        rectAngle = typedArray.getDimension(R.styleable.input_pas_style_rectAngle, rectAngle);
        isPwd = typedArray.getBoolean(R.styleable.input_pas_style_isPwd, isPwd);
        autoSize = typedArray.getBoolean(R.styleable.input_pas_style_autoSize, autoSize);
...
//    }
    ...
    private void drawText(Canvas canvas) {
        ...
        // 画文字
        List<String> list = subStringToList(getPasswordString());
